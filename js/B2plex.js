...
let questions = [
    {
        ...
        imgSrc : "../assets/img/BANNERS_PROGRAMA_ADULTOS_BASIC_2.png",
...
function scoreRender(){
    ...
    let img = (scorePerCent >= 80) ? "../assets/img/NEXT.png" :
              ...
              (scorePerCent >= 40) ? "../assets/img/BANNERS_PROGRAMA_ADULTOS_BASIC_2.png" :
              (scorePerCent >= 20) ? "../assets/img/BANNERS_PROGRAMA_ADULTOS_BASIC_2.png" :
...
if (scorePerCent >= 60) {
    ...
    imprimir.innerText = 'Go to Basic 3';
    ...
    imprimir.setAttribute("href", "../pages/tarjetas.html");
    scoreDiv.append(imprimir);
}
